...
<?php require_once 'a_keretaapi.php'; ?>
        ...
        <form action="" method="post">
            ...
            <div class="row row-cols-1 row-cols-md-2 row-cols-lg-5">
                <div class="col form-group dropdown search-box-dari">
                    <label for="keretaDari"><i class="fa fa-map"></i> Dari</label>
                    <input name="dari" type="text" class="form-control" id="keretaDari" placeholder="Kota Berangkat" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" autocomplete="off" required value="<?php echo (isset($_POST['dari'])) ? $_POST["dari"] : '' ?>">
                ...
                <div class="col form-group dropdown search-box-ke">
                    <label for="keretaKe"><i class="fa fa-location-arrow"></i> Ke</label>
                    <input name="tujuan" type="text" class="form-control" id="keretaKe" placeholder="Kota Tujuan" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" autocomplete="off" required value="<?php echo (isset($_POST['tujuan'])) ? $_POST["tujuan"] : '' ?>">
                ...
                <div class="col col-md-12 form-group dropdown search-box-ke">
                    <label for="penumpang"><i class="fa fa-paperclip"></i> Penumpang</label>
