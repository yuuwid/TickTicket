...
<div class="jumbotron jumbotron-fluid jum-pesawat mt-5 pt-5">
    <div class="container">
        <h1 class="display-5 pt-4"><b>Mau Terbang Kemana?</b></h1>
...
<div class="container pb-5" style="margin-top: -200px;">
    ...
    <div class="card p-4 pt-5 pb-5">
        ...
        <form action="" method="post">
            ...
            <div class="text-right">
                ...
                <a href="#pilihtikets" class="text-decoration-none"><button id="caritiket" name="cari" type="submit" class="btn btn-info" >Cari <i class="fa fa-paper-plane"></i></button></a>
            </div>
        </form>
    ...
    <?php if (isset($data_tikets)) : ?>
        <div class="card p-5 mt-2">
            <div id="pilihtikets" class="row row-cols-1 row-cols-md-1 row-cols-lg-2">
    ...
    <?php if (isset($checkout1)) : ?>
        <div class="card p-3 mt-3">
            ...
            <hr>
            <div class="container card p-3">
                <form method="POST" action="tiket_checkout.php?jenis=Tiket%20Pesawat">
